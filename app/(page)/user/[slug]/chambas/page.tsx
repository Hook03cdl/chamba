    ...
    return (
        <div>
            {chambas && (
                ...
                <Each of={chambas} render={(c: ChambaProps) => (
                    <Card href={`/chamba/${c.slug}`} src={c.path} id={c.id} worker_slug={c.worker_slug}
                          name={String(c.title)} description={c.description} worker_name={c.worker_name}
                          rating={c.rating}
                          job_name={c.job_name}/>
                )}/>
